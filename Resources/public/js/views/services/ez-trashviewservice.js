...
YUI.add('ez-trashviewservice', function (Y) {
    ...
    Y.eZ.TrashViewService = Y.Base.create('trashViewService', Y.eZ.ViewService, [], {
        ...
        _loadTrashItem: function(itemHash, inTrashList, trashItems, callback) {
            var ContentInfo = this.get("contentInfoModelConstructor"),
                Location = this.get("locationModelConstructor"),
            ...
            contentInfo.set('id', itemHash.Content._href);

            contentInfo.load(loadOptions, tasks.add(function (error) {
                contentType.set('id', contentInfo.get('resources').ContentType);

                if (error) {
                    service._error("Failed to load trash item name with REST API");
                }
        ...
        */
        ...
        ATTRS: {
             ...
             *  - struct.contentInfo: Y.eZ.ContentInfo
            ...
            /**
             * Holds the eZ.ContentInfo constructor function
             *
             * @attribute contentInfoModelConstructor
             * @type {Function}
             * @default Y.eZ.ContentInfo
             */
            contentInfoModelConstructor: {
                value: Y.eZ.ContentInfo
            },
